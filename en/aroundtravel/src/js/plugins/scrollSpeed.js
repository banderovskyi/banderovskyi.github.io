(function($){jQuery.scrollSpeed=function(step,speed,easing){var $document=$(document),$window=$(window),$body=$('html, body'),option=easing||'default',root=document.documentElement.scrollTop||document.body.scrollTop,scroll=false,scrollY,scrollX,view;if(window.navigator.msPointerEnabled)
